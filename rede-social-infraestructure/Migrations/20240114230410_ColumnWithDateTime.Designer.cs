...
namespace rede_social_infraestructure.Migrations
{
    ...
    [Migration("20240114230410_ColumnWithDateTime")]
    partial class ColumnWithDateTime
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("rede_social_domain.Models.EFModels.PostEF", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 1, 14, 20, 4, 10, 747, DateTimeKind.Unspecified).AddTicks(9558), new TimeSpan(0, -3, 0, 0, 0)));
                    ...
                    b.Property<DateTimeOffset>("LastUpdate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 1, 14, 20, 4, 10, 747, DateTimeKind.Unspecified).AddTicks(9775), new TimeSpan(0, -3, 0, 0, 0)));
