...
namespace rede_social_infraestructure.Migrations
{
    ...
    [Migration("20240114224625_UpdateDateTimeWithUTC")]
    partial class UpdateDateTimeWithUTC
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("rede_social_domain.Models.EFModels.PostEF", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2024, 1, 14, 19, 46, 25, 768, DateTimeKind.Utc).AddTicks(6769));
                    ...
                    b.Property<DateTime>("LastUpdate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2024, 1, 14, 19, 46, 25, 768, DateTimeKind.Utc).AddTicks(6996));
